  ...
  <div class="wrapper">
    <header class="main-header">
        ...
        <div class="container">
            ...
            <a href="./" class="navbar-brand"><b>TalensFeminins</b></a>
            ...
            <ul class="nav navbar-nav">
                ...
                <a href="<?=site_url('accueil')?>" >
                    <i class="glyphicon glyphicon-home"></i> Voir le Site
                </a>
                </li>
            </ul>
            </div>
            ...
            <section class="content">
                <div class="login-box">
                    ...
                    <div class="login-box-body">
                        <p class="login-box-msg">Connexion||Administration</p>
                       
                          <?=form_open('journaliste/login') ?>
                            <div class="form-group has-feedback">
                                <?= form_input([ 'type'=>"text", 'class'=>"form-control", 'placeholder'=>"Utilisateur", 'style'=>"border-radius:40px;", 'name'=>"login", 'value'=>set_value('login')])?>
    ...
    <footer class="main-footer">
            ...
            <strong>Copyright &copy; 2021 <a href="https://zibu.000webhostapp.com">Zibu_design</a>.</strong>
            </div>
            <!-- /.container -->
    </footer>
  </div>
