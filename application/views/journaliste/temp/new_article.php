...
<head>
  ...
  <title>Journaliste | Nouveau</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <?=form_open_multipart('journaliste/submit_new_article') ?>
      <!-- Main content -->
            ...
            <div class="box">
              ...
              <!-- /.box-header -->
                <div class="box-body pad">
                 ...
                 <div class="col-md-12">
                    <div class="form-group">
                        <label for="exampleInputEmail1">Joindre Document(PDF)</label>
                        <?= form_input([ 'type'=>"file", 'class'=>"form-control", 'id'=>"exampleInputEmail1", 'name'=>"pdf"])?>

                        <?=form_error('pdf', '<p class="text-danger">', '</p>')?>
                        <?php if (isset($error)){echo '<p class="text-danger">'.$error.'</p>';}?>
                    </div>
                </div>
